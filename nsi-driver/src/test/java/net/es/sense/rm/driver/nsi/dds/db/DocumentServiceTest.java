...
public class DocumentServiceTest {
  ...
  public void verify() throws JAXBException, IOException, DatatypeConfigurationException {
    ...
    Collection<Document> get = documentService.get();
    long lastDiscovered = 0;
    for (Document d : get) {
      if (d.getLastDiscovered() > lastDiscovered) {
        lastDiscovered = d.getLastDiscovered();
      }
    }

    Assert.assertEquals(documentService.getLastDiscovered(), lastDiscovered);
  }
